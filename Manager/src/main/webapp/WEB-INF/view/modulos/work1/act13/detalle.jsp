...
<head>
	...
	<link href="<c:url value="/resources/manager/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css" />" rel="stylesheet">
	...
	<link href="<c:url value="/resources/manager/plugins/bootstrap-eonasdan-datetimepicker/build/css/bootstrap-datetimepicker.min.css" />" rel="stylesheet">
...
<body>
                        	...
                        	<form class="form-horizontal form-bordered">
                           	  <div class="row">
                           	  	...
                           	  	<div class="form-group col-md-6">
                           	  		...
                           	  		<a href="#" class="btn btn-success m-r-5" style="margin-top: 5px; text-align: center;" onclick="JavaScript: aceptarAgenda();" id="btn_activae">
                           	  			<i class="fa fa-check-square-o fa-2x pull-left"></i>
                           	  			Enviar
                           	  		</a>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a href="JavaScript: deleteAgendado();" class="btn btn-lg btn-danger">Eliminar</a>
					</div>
				</div>
			</div>
		</div>
    ...
    <!-- #modal-success -->
	<div class="modal fade"  id="modalg-success_agenda" >
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				...
				<div class="modal-body" id="modalg-success-text-agenda"></div>
				
				<div class="modal-footer">
					 <a href="JavaScript: $(location).attr('href','/Manager/workflowEtapa1/AgendarKickOff');;" class="btn btn-lg btn-success">Cerrar</a> 
				</div>
			</div>
		</div>
	</div>
   ...
   <script src="<c:url value="/resources/manager/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js" />"></script>
   
   <script src="<c:url value="/resources/manager/plugins/bootstrap-eonasdan-datetimepicker/build/js/bootstrap-datetimepicker.min.js" />"></script>
	...
	<script src="<c:url value="/resources/app/act13/detalle.js" />"></script>
	...
	<script src="<c:url value="/resources/manager/js/apps.min" />"></script>
