...
<%
 ...
 URL url = application.getResource("/WEB-INF/lang/"+langOption+"/activity14.properties");
...
<body>
                        	...
                        	<form class="form-horizontal form-bordered">
                           	  <div class="row">
                           	  	...
                           	  	<div class="form-group col-md-6">
                           	  		...
                           	  		<a href="#" class="btn btn-success m-r-5" style="margin-top: 5px; text-align: center;" onclick="JavaScript: aceptarReunion();" id="btn_activae">
                           	  			<i class="fa fa-check-square-o fa-2x pull-left"></i>
                           	  			Realizada
                           	  		</a>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Asistencia</h4>
                        </div>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Repocitorio</h4>
                        </div>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Instructivo</h4>
                        </div>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Aprobacion</h4>
                        </div>
                        ...
                        <div id="panel_08" class="panel-body panel-form" style="margin-top: 10px; margin-left: 10px;">
                           ...
                           <div class="row">
                       		  <div class="form-group col-md-6">
									<label class="control-label col-md-4" style="background: #f0f3f4; font-weight: bold;">Director de Campo </label>
									<div class="col-md-8">
                                        <select class="default-select2 form-control" id="txt_aprob_01" name="txt_aprob_01" style="width: 100%;"></select>
									</div>
							  </div>
							  <div class="form-group col-md-6">
									<label class="control-label col-md-4" style="background: #f0f3f4; font-weight: bold;">Jefe de Calidad </label>
									<div class="col-md-8">
                                        <select class="default-select2 form-control" id="txt_aprob_02" name="txt_aprob_02" style="width: 100%;"></select>
									</div>
							  </div>  	  	
                           ...
                           <div class="row">
                       		  <div class="form-group col-md-6">
									<label class="control-label col-md-4" style="background: #f0f3f4; font-weight: bold;">Procesamiento </label>
									<div class="col-md-8">
                                        <select class="default-select2 form-control" id="txt_aprob_03" name="txt_aprob_03" style="width: 100%;"></select>
									</div>
							  </div>
							  <div class="form-group col-md-6">
									<label class="control-label col-md-4" style="background: #f0f3f4; font-weight: bold;">Scripting </label>
									<div class="col-md-8">
                                        <select class="default-select2 form-control" id="txt_aprob_04" name="txt_aprob_04" style="width: 100%;"></select>
									</div>
							  </div>  	  	
    ...
    <%@ include file="../../../general-modal.jsp" %>
     ...
     <!-- #modal-success -->
	<div class="modal fade"  id="modalg-success_reunion" >
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="modalg-success-text-reunion"></div>
				
				<div class="modal-footer">
					 <a href="JavaScript: $(location).attr('href','/Manager/workflowEtapa1/KickOff');;" class="btn btn-lg btn-success">Cerrar</a> 
				</div>
			</div>
		</div>
	</div>
	...
	<script src="<c:url value="/resources/app/act14/detalle.js" />"></script>
