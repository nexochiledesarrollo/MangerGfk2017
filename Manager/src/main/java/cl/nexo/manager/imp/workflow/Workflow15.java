...
public class Workflow15 implements AccessWorkflow15 {
	private static final Logger logger = Logger.getLogger(Workflow15.class);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserKick(int id, String lang){
		...
		ArrayList<ObjEstudio> result1 = this.getListEstudioByUserResAsigKick(1,id,lang);
		ArrayList<ObjEstudio> result2 = this.getListEstudioByUserResAsigKick(2,id,lang);
		ArrayList<ObjEstudio> result3 = this.getListEstudioByUserResAsigKick(3,id,lang);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserAsig(int id, String lang){
		...
		ArrayList<ObjEstudio> result1 = this.getListEstudioByUserResAsigPersonal(1,id,lang);
		ArrayList<ObjEstudio> result2 = this.getListEstudioByUserResAsigPersonal(2,id,lang);
		ArrayList<ObjEstudio> result3 = this.getListEstudioByUserResAsigPersonal(3,id,lang);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserRevFondos(int id, String lang){
		...
		ArrayList<ObjEstudio> result1 = this.getListEstudioByUserResRevFondos(1,id,lang);
		ArrayList<ObjEstudio> result2 = this.getListEstudioByUserResRevFondos(2,id,lang);
		ArrayList<ObjEstudio> result3 = this.getListEstudioByUserResRevFondos(3,id,lang);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserResAsig(int idUser, int User, String lang){
		...
		String query="SELECT "
				  ...
				  query = query + " AND o.cola_operacion =  " + Constantes.Cola_Pdte_agenda_kickOff;
	...
	public ArrayList<ObjEstudio> getListEstudioByUserResAsigKick(int idUser, int User, String lang){
		...
		String query="SELECT "
				  ...
				  query = query + " AND o.cola_operacion =  " + Constantes.Cola_Pdte_kickOff;
				  query = query + " ORDER BY o.id_operacion DESC ";
		try {
			  conn = dataSource.getConnection();
			  PreparedStatement ps = conn.prepareStatement(query);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserResRevFondos(int idUser, int User, String lang){
		...
		String query="SELECT "
				  ...
				  query = query + " AND o.cola_operacion =  " + Constantes.Cola_Pdte_Aprobacion;
				  query = query + " ORDER BY o.id_operacion DESC ";
		try {
			  conn = dataSource.getConnection();
			  PreparedStatement ps = conn.prepareStatement(query);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserResAsigPersonal(int idUser, int User, String lang){
		...
		String query="SELECT * FROM ( "
				  ...
				  +" LEFT JOIN man_login_user us2 on us2.id_user = m.res_us2_op "
				  +" LEFT JOIN man_login_user us3 on us3.id_user = m.res_us3_op "
				  +" LEFT JOIN man_workflow_estudio ws on ws.id_operacion = o.id_operacion and ws.id_actividad=" + Constantes.Actividad_Asig_personal ;
				  ...
				  query = query + " AND (o.cola_operacion = " + Constantes.Cola_Pdte_desarrollo_org +  " or o.cola_operacion = " + Constantes.Cola_En_proceso_desarrollo_org + " ) ) AS tb "
				  		        + " where  (tb.estado_act11 <> " + Constantes.Estado_Asignacion_perso_aceptada + " OR tb.estado_act11 IS NULL ) ";
